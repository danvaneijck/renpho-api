...
:meth:`renpho.RenphoClient.get_girth_measurements` and
:meth:`renpho.RenphoClient.upload_girth_measurements` for the API calls.
"""
...
def build_girth_record(
    ...
    *,
    ...
    Returns:
        ...
        :meth:`renpho.RenphoClient.upload_girth_measurements`.
    """
    record = {
        "mac": mac,
...
# Human-readable formatting lives with the other formatters:
# see :func:`renpho.export.format_girth`.
